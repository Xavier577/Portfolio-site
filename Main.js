...
window.onload = () => {
	...
	sr.reveal('#facebook-icon', { origin: 'left', duration: 2200, delay: 1000 });
	sr.reveal('#whatsapp-icon', { origin: 'left', duration: 2300, delay: 2000 });
	sr.reveal('#linkedin-icon', { origin: 'left', duration: 2400, distance: '90px', delay: 3000 });
	sr.reveal('#telegram-icon', { origin: 'left', duration: 2500, distance: '100px', delay: 4000 });
};
